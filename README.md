Processing DNA-seq of soil README: Protocol for processing microbial amplicon sequences (16S & ITS) from dryland soils
...
Code within files is bash script, work was conducted in NMSU high-power computing Discovery cluster.
